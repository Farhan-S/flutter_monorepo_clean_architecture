...
class ApiRoutes {
  ...
  // Test endpoints (using JSONPlaceholder for testing)
  static const String posts = '/posts';
  static String postById(int id) => '/posts/$id';
  static String postsByUserId(int userId) => '/posts?userId=$userId';

  // Non-existent endpoint for error testing
  static const String nonExistentEndpoint = '/nonexistent-endpoint-404';
